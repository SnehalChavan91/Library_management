...
from .views import (author_signup,common_login,add_genre,get_all_authors,
                    get_author_details,get_books_of_author,delete_genre,add_book,
                    edit_book,export_books_by_genre,get_all_authors_protected)
...
path('get/all/authors/protected/', get_all_authors_protected, name='get_all_authors_protected'),
